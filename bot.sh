...
if [[ $user == "" ]]; then
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Şifre: \e[0m\n"
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcı İsmi: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcda Cookies bulundu\e[0m\e[1;77m %s\e[0m\n" $user
...
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93mB BU DOSYAYA KAYDEİLDİ credentials\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m]iNSTAGRAM HESABINA GİRİŞ DENENENİLİYOR\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;31m Eğer \"Ctrl + c\" Basarsanız Program durur\e[0m\n"
sleep 4
while [[ true ]]; do
...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] Program 1 saatde 30 takipçi gönderir! \e[0m\n"
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m CTRL BASARSAN PROGRAM DURUR \e[0m\n"
sleep 5
...
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m02\e[0m\e[1;31m]\e[0m\e[1;93m Takipçi Yolla moruq\e[0m\n"
printf "\n"


read -p $' \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;77m Seçenek Seçin : \e[0m' option
